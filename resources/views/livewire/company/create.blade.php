<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('company.user_id') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('mediaCollections.company_logo') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('mediaCollections.company_docs') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('company.commission_type') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('company.commission_value') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('company.status') ? 'invalid' : '' }}">
