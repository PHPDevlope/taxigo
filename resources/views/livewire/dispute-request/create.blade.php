<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('disputeRequest.user_provider') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('disputeRequest.request_detail') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('disputeRequest.dispute_id') ? 'invalid' : '' }}">
