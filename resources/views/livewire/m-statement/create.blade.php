<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('mStatement.user_id') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('mStatement.document_id') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('mediaCollections.m_statement_files') ? 'invalid' : '' }}">
