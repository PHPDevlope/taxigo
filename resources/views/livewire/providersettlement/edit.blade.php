<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('providersettlement.provider_name') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('providersettlement.amount') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('providersettlement.type') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('providersettlement.send') ? 'invalid' : '' }}">
