<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.user_name_id') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.provider_name_id') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.total_distance') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.ride_start_time') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.ride_end_time') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.otp') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.pickup_address') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.drop_address') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.base_price') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.distance_price') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.discount_price') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.eta_discount_price') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.tax_price') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.surge_price') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.total_amount') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.coupon_deduction') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.coupon_id') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.paid_amount') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.provider_earnings') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.provider_admin_commission') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-2 {{ $errors->has('requestHistory.ride_status') ? 'invalid' : '' }}">
    ...
    <div class="form-group mt-4">
        ...
        <a href="{{ route('admin.request-history') }}" class="btn btn-secondary btn-sm">
            {{ trans('global.cancel') }}
        </a>
    </div>
</form>
