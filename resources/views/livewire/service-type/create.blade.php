<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('serviceType.service_name') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('serviceType.provider_name') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('mediaCollections.service_type_service_maker_image') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('mediaCollections.service_type_service_image') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('serviceType.description') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('serviceType.outstation_oneway_price') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('serviceType.outstation_roundtrip_price') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('serviceType.driver_bata') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('serviceType.rental_per_hour') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('peak_time') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('serviceType.night_fare') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('geo_fencing') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('serviceType.status') ? 'invalid' : '' }}">
