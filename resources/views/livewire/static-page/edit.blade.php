<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('staticPage.page_name') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('staticPage.content') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('staticPage.data') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('staticPage.status') ? 'invalid' : '' }}">
