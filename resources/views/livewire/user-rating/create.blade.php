<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('userRating.request_id') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('userRating.user_name_id') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('userRating.provider_name_id') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('userRating.rating') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('userRating.date_time') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('userRating.comments') ? 'invalid' : '' }}">
