<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('mediaCollections.user_profile') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('user.mobile') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('user.mobile_verified_at') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('user.otp') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('user.firebase_token') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('user.device_token') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('user.device_type') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('user.device') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('user.dob') ? 'invalid' : '' }}">
    ...
    <div class="form-group {{ $errors->has('user.provider_status') ? 'invalid' : '' }}">
