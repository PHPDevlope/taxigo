...
@section('content')
    ...
    <main class="py-6 bg-surface-secondary">
        <div class="container-fluid">
            @livewire('dispatcher-panel.index')
        </div>

        <div class="offcanvas offcanvas-end" style="width: 550px;" data-bs-scroll="true" data-bs-backdrop="true" tabindex="-1" id="offcanvasMain" aria-labelledby="offcanvasExampleLabel">
            ...
            <div class="offcanvas-body pt-0">
                @livewire('dispatcher-panel.create')
            </div>
        </div>
    </main>
@endsection
