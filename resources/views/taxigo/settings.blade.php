            ...
            <div class="mb-npx">
                <div class="row align-nav-item">
                    ...
                    <div class="col-6 text-end">
                        <div class="mx-n1">
                            @if(request()->is("admin/settings/m-settings*"))
                ...
                <ul class="nav nav-tabs mt-4 overflow-x border-0">
                    ...
                    @endif
                    @if(request()->is("admin/settings/app-settings*"))
                        <li class="nav-item">
                            <a class="nav-link active">
                                <i class="fa-fw c-sidebar-nav-icon fas fa-cogs"></i>
                                App Settings
                    ...
                    @endif
                    @if(request()->is("admin/settings/payment-settings*"))
                        <li class="nav-item">
                            <a class="nav-link active">
                                <i class="fa-fw c-sidebar-nav-icon fas fa-cogs"></i>
                                Payment Settings
    ...
    <main class="py-6 bg-surface-secondary">
        <div class="container-fluid">
            <div>
                ...
                @elseif(request()->is("admin/settings/app-settings"))
{{--                    {{ route("admin.app-settings.index") }}--}}
                @elseif(request()->is("admin/settings/payment-settings"))
